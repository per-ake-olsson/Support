...
Detta licensavtal (“Avtalet”) reglerar din användning av programvaran PwdGen (“Programvaran”), tillhandahållen av Eureka Consulting AB (“Utgivaren”). Genom att installera eller använda Programvaran accepterar du villkoren i detta Avtal. Om du inte accepterar villkoren ska du inte installera eller använda Programvaran.

## 1. Licensgivning

Utgivaren ger dig en begränsad, icke-exklusiv och icke‑överförbar licens att installera och använda Programvaran för personligt eller internt bruk. Programvaran får installeras på det antal enheter som är tillåtet enligt Microsoft Stores villkor eller enligt Utgivarens instruktioner.
...
Du får använda Programvaran i enlighet med detta Avtal. Du får inte distribuera, sälja, hyra ut, leasa, låna ut eller på annat sätt tillgängliggöra Programvaran för tredje part utan Utgivarens skriftliga medgivande.
...
Utgivaren kan tillhandahålla uppdateringar eller uppgraderingar. Sådana omfattas av detta Avtal om inte annat anges. Utgivaren har ingen skyldighet att tillhandahålla support eller uppdateringar.
...
Om någon bestämmelse i Avtalet bedöms ogiltig ska den ersättas av en giltig bestämmelse som ligger nära den ursprungliga avsikten. Microsoft är inte part i detta Avtal och ansvarar inte för Programvaran.
